...
connection.onDidChangeConfiguration((change) => {
    ...
    if (process.platform === 'win32') {
        remappings = (0, util_1.replaceRemappings)(remappings, settings.solidity.remappingsWindows);
    }
    else {
        remappings = (0, util_1.replaceRemappings)(remappings, settings.solidity.remappingsUnix);
    }
