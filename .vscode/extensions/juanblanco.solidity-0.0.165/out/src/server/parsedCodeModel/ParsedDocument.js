...
class ParsedDocument extends parsedCode_1.ParsedCode {
    ...
    getDocumentsThatReference(document) {
        let returnItems = [];
        if (this.isTheSame(document) || // it is the doc so needs be added as a flag for the reference return it later on can be filtered dup
